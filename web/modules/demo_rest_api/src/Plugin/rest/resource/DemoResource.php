 ...
 *
 * @RestResource (
 *   id = "demo_rest_api_demo",
 *   label = @Translation("Demo"),
 *   uri_paths = {
 *     "canonical" = "/api/demo-rest-api-demo/{id}",
 *     "create" = "/api/demo-rest-api-demo"
 *   }
 * )
 *
 * @DCG
...
class DemoResource extends ResourceBase {
  ...
  public function __construct(
    ...
    $this->storage = $keyValueFactory->get('demo_rest_api_demo');
  }
  ...
  public function post(array $data) {
    ...
    $this->logger->notice('Create new demo record @id.');
   ...
   */
  public function get() {
   $response = ['message' => 'Hello, this is a test'];
  ...
  public function patch($id, array $data) {
    ...
    $this->logger->notice('The demo record @id has been updated.');
